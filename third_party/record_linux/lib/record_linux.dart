...
class RecordLinux extends RecordPlatform {
  ...
  Future<Stream<Uint8List>> startStream(
    ...
    // The app uses file-based recording on mobile. Flutter's generated
    // `dart_plugin_registrant.dart` imports every desktop plugin on all
    // platforms, so this method must exist for builds to succeed.
    //
    // TODO: Implement real streaming for Linux if/when we support it.
    throw UnsupportedError('startStream is not implemented for record_linux.');
  }
